import section3_item1_png from '@assets/images/section3_item1.png';
import section3_item2_png from '@assets/images/section3_item2.png';
import section3_item3_png from '@assets/images/section3_item3.png';
import section3_item4_png from '@assets/images/section3_item4.png';
    ...
    <div id="section3" className="w-full px-[10vw] xl:px-0 py-12 xl:py-[100px] text-center bg-black text-white">
      ...
      <ul className="w-full xl:flex xl:justify-center">
        ...
        <li className='xl:w-[15.7vw] xl:mr-16 mb-16 xl:mb-0'>
          <img src={ section3_item1_png } alt="section3 item1 image" title="section3 item1 image" className='mx-auto mb-4 w-16 h-16 object-contain' />
        ...
        {/* item 2 */}
        <li className='xl:w-[15.7vw] xl:mr-16 mb-16 xl:mb-0'>
          <img src={ section3_item2_png } alt="section3 item2 image" title="section3 item2 image" className='mx-auto mb-4 w-16 h-16 object-contain' />
        ...
        {/* item 3 */}
        <li className='xl:w-[15.7vw] xl:mr-16 mb-16 xl:mb-0'>
          <img src={ section3_item3_png } alt="section3 item3 image" title="section3 item3 image" className='mx-auto mb-4 w-16 h-16 object-contain' />
